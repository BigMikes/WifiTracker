...
/**
 * The configuration screen for the {@link LocationWidget LocationWidget} AppWidget.
 */
public class LocationWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.project.mps.wifitracker.LocationWidget";
